...
int my_id;
#pragma omp threadprivate(my_id)
...
void sort_list(int q) {
    ...
    #pragma omp parallel num_threads(num_threads) private(i, level, my_own_blk, my_own_idx, my_blk_size, my_search_blk, my_search_idx, my_search_idx_max, my_write_blk, my_write_idx, my_search_count, idx, i_write)
    {
        my_id = omp_get_thread_num();
        for(level=-1;level<q;level++)
        {
            if (level==-1)
            {
...
// Now executing k=12 and q=0
// List Size = 4096, Threads = 1, error = 0, time (sec) =   0.0071, qsort_time =   0.0010
// Now executing k=12 and q=1
// List Size = 4096, Threads = 2, error = 0, time (sec) =   0.0068, qsort_time =   0.0010
// Now executing k=12 and q=2
// List Size = 4096, Threads = 4, error = 0, time (sec) =   0.0069, qsort_time =   0.0009
// Now executing k=12 and q=4
// List Size = 4096, Threads = 16, error = 0, time (sec) =   0.0147, qsort_time =   0.0010
// Now executing k=12 and q=6
// List Size = 4096, Threads = 64, error = 0, time (sec) =   0.0416, qsort_time =   0.0004
// Now executing k=12 and q=8
// List Size = 4096, Threads = 256, error = 0, time (sec) =   0.2235, qsort_time =   0.0003
// Now executing k=12 and q=10
// List Size = 4096, Threads = 1024, error = 0, time (sec) =   8.2073, qsort_time =   0.0005
// Now executing k=20 and q=0
// List Size = 1048576, Threads = 1, error = 0, time (sec) =   0.1502, qsort_time =   0.1261
// Now executing k=20 and q=1
// List Size = 1048576, Threads = 2, error = 0, time (sec) =   0.0929, qsort_time =   0.1255
// Now executing k=20 and q=2
// List Size = 1048576, Threads = 4, error = 0, time (sec) =   0.0597, qsort_time =   0.1286
// Now executing k=20 and q=4
// List Size = 1048576, Threads = 16, error = 0, time (sec) =   0.0324, qsort_time =   0.1391
// Now executing k=20 and q=6
// List Size = 1048576, Threads = 64, error = 0, time (sec) =   0.0519, qsort_time =   0.1490
// Now executing k=20 and q=8
// List Size = 1048576, Threads = 256, error = 0, time (sec) =   0.2839, qsort_time =   0.2341
// Now executing k=20 and q=10
// List Size = 1048576, Threads = 1024, error = 0, time (sec) =   8.1391, qsort_time =   0.1425
// Now executing k=28 and q=0
// List Size = 268435456, Threads = 1, error = 0, time (sec) =  47.6871, qsort_time =  46.8509
// Now executing k=28 and q=1
// List Size = 268435456, Threads = 2, error = 0, time (sec) =  24.0996, qsort_time =  47.2172
// Now executing k=28 and q=2
// List Size = 268435456, Threads = 4, error = 0, time (sec) =  12.7390, qsort_time =  47.6660
// Now executing k=28 and q=4
// List Size = 268435456, Threads = 16, error = 0, time (sec) =   3.5395, qsort_time =  47.6835
// Now executing k=28 and q=6
// List Size = 268435456, Threads = 64, error = 0, time (sec) =   1.9392, qsort_time =  46.9977
// Now executing k=28 and q=8
// List Size = 268435456, Threads = 256, error = 0, time (sec) =   2.2845, qsort_time =  47.5727
// Now executing k=28 and q=10
// List Size = 268435456, Threads = 1024, error = 0, time (sec) =   4.7662, qsort_time =  46.9004